...
const xaudio = new Audio('./x-play.mp3')
const oaudio = new Audio('./o-play.mp3')

const waudio = new Audio('./win.mp3')
...
function colornone(){
    ...
    {
        console.log("true")
    row1_1.style.backgroundColor="#000000"
    row1_2.style.backgroundColor="#000000"
    row1_3.style.backgroundColor="#000000"

    row2_1.style.backgroundColor="#000000"
    row2_2.style.backgroundColor="#000000"
    row2_3.style.backgroundColor="#000000"

    row3_1.style.backgroundColor="#000000"
    row3_2.style.backgroundColor="#000000"
    row3_3.style.backgroundColor="#000000"
    }
}
...
function wincolor1(){
    ...
    {
        row1_1.style.backgroundColor="#f5f4c4"
        row1_2.style.backgroundColor="#f5f4c4"
        row1_3.style.backgroundColor="#f5f4c4"
    }  
    else if(check4 == check5 && check5 == check6 && check6 != 0) 
    {
        row2_1.style.backgroundColor="#f5f4c4"
        row2_2.style.backgroundColor="#f5f4c4"
        row2_3.style.backgroundColor="#f5f4c4"
    }
    else if(check7 == check8 && check8 == check9 && check9 != 0) 
    {
        row3_1.style.backgroundColor="#f5f4c4"
        row3_2.style.backgroundColor="#f5f4c4"
        row3_3.style.backgroundColor="#f5f4c4"
    }
...
function wincolor2(){
    if(check1 == check2 && check2 == check3 && check3 != 0)
    {
        row1_1.style.backgroundColor="#e4f000"
        row1_2.style.backgroundColor="#e4f000"
        row1_3.style.backgroundColor="#e4f000"
    }  
    else if(check4 == check5 && check5 == check6 && check6 != 0) 
    {
        row2_1.style.backgroundColor="#e4f000"
        row2_2.style.backgroundColor="#e4f000"
        row2_3.style.backgroundColor="#e4f000"
    }
    else if(check7 == check8 && check8 == check9 && check9 != 0) 
    {
        row3_1.style.backgroundColor="#e4f000"
        row3_2.style.backgroundColor="#e4f000"
        row3_3.style.backgroundColor="#e4f000"
    }
    else if(check1 == check4 && check4 == check7 && check7 != 0) 
    {
        row1_1.style.backgroundColor="#e4f000"
...
const pagain = document.querySelector(".playagain")
...
const dmtext = document.querySelectorAll(".dm-text")
const lmtext = document.querySelectorAll(".lm-text")
const dmgrid = document.querySelector(".main-grid")
const dmcell = document.querySelectorAll(".cell")
...
darkmode.onclick = () => {
    ...
    {    
        ...
        dmtext.forEach(element => {
            element.style.color = "#cfcece";
        });
        lmtext.forEach(element => {
            console.log("hello1")
            element.style.color = "black";
        });
        dmgrid.style.backgroundColor = "#cfcece"
        dmcell.forEach(element => {
            element.style.backgroundColor = "black";
        });
        darkmode.style.backgroundColor="#cfcece"
        dark=true
        back2.classList.toggle("back2")
    }
    else if(dark==true)
    {    
        ...
        dmgrid.style.backgroundColor = "#000000"
        dmcell.forEach(element => {
